...
import { newSellerPassword } from "../redux/actions/sellerAction";
...
function NewSellerPasswordForm() {
  ...
  const handleNewPassword = () => {
    ...
    dispatch(newSellerPassword(newPass, actualToken));
...
export default NewSellerPasswordForm;
